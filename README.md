...
**TUTO - Routeur Ubiquiti pour Internet + Livebox pour TV + Téléphone**
...
ARCHITECTURE ORANGE DHCP / IPV4 (PAS DE SUPPORT DE IPV6 POUR LE MOMENT)
...
- ATTENTION VERSION POUR FIRMWARE 1.10.3
...
3. Calcul option DHCP rfc3118-auth
----------------------------------
...
5. Transfert du config-new.boot sur le routeur
----------------------------------------------
